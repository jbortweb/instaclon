...
<body class="bg-gray-100">
  <header class="p-5 border-b bg-white shadow">
    <div class="container mx-auto flex justify-between items-center">
      <a href="{{route('inicio')}}" class="text-3xl font-black">
        InstaBort
      </a>
      ...
      @auth  <!-- Si esta autentificado sale este contenido -->
        ...
        <a 
        class="flex items-center gap-2 bg-white border p-2 mr-10 text-gray-600 rounded text-sm uppercase font-bold cursor-pointer"
        ...
        <a class="font-bold text-gray-600 text-sm pr-4" href="{{route('posts.index', auth()->user()->username)}}">
